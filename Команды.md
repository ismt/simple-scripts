...
pv mysqldump.zstd | pzstd -d -c | mysql --host=localhost --user=root --password --compress --database=t
...
cat mysqldump.zstd | pzstd -d -c | mysql --host=localhost --user=root --password --compress --database=t
...
gzip -d -c ./mysqldump.sql.gz | mysql --host=localhost --user=root --password --compress --database=DB_NAME
